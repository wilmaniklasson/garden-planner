...
const Plants: React.FC<OptionProps> = ({ selectedTool, handleSelectTool, isOpen, toggle }) => {
  const items = [
    { name: 'Plant Nr 1', img: PlantNr1 },
    { name: 'Plant Nr 2', img: PlantNr2 },
    { name: 'Plant Nr 3', img: PlantNr3 },
    { name: 'Plant Nr 4', img: PlantNr4 },
    { name: 'Plant Nr 5', img: PlantNr5 },
    { name: 'Plant Nr 6', img: PlantNr6 },
    { name: 'Plant Nr 7', img: PlantNr7 },
    { name: 'Plant Nr 8', img: PlantNr8 },
    { name: 'Plant Nr 9', img: PlantNr9 },
    { name: 'Plant Nr 10', img: PlantNr10 },
    { name: 'Plant Nr 11', img: PlantNr11 },
    { name: 'Plant Nr 12', img: PlantNr12 },
    { name: 'Plant Nr 13', img: PlantNr13 },
    { name: 'Plant Nr 14', img: PlantNr14 },
    { name: 'Plant Nr 15', img: PlantNr15 },
    { name: 'Plant Nr 16', img: PlantNr16 },
